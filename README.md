...
перший запускає typecheck, unit-тести й build, другий підіймає звичайний
Compose-стек, виконує smoke та browser regression. Міграції виконує той
самий API-контейнер, окремий migration image або повний дубльований build
context не створюється.
